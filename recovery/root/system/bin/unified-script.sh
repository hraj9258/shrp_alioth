...
load_INDIA()
{
    ...
    resetprop "ro.product.system.name" "twrp_aliothin"
    resetprop "ro.product.vendor.name" "twrp_aliothin"
    resetprop "ro.product.system_ext.name" "twrp_aliothin"
    resetprop "ro.product.odm.name" "twrp_aliothin"
    resetprop "ro.product.product.name" "twrp_aliothin"
